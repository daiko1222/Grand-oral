...
<body>
    ...
    <div class="quiz_choice">
        <div class="quiz_choice1">
            <div>
                <a href="./Quiz/quiz.php"> Jeux de mots et culture générale</a>
            </div>
        </div>
        <div class="quiz_choice2">
            <div>
                <a href="#">Jeux de mots et culture générale</a>
            </div>
        </div>
    ...
    <div class="quiz_choice">
        <div class="quiz_choice1">
            <div>
                <a href="Quiz/quiz.php">Histoire</a>
            </div>
        </div>
        <div class="quiz_choice2">
            <div>
                <a href="Quiz/quiz.php">Culture Générale</a>
            </div>
        </div>
        <div class="quiz_choice3">
            <div>
                <a href="Quiz/quiz.php">Jeux Vidéos</a>
            </div>
        </div>
        <div class="quiz_choice4">
            <div>
                <a href="Quiz/quiz.php">Célébrités</a>
            </div>
        </div>
    </div>
    <?php
